...
#include "../Public/Engine/Components/StaticMesh.h"
#include "../Public/Engine/Components/Collision.h"
#include "../Public/Engine/Components/LightSource.h"
...
void RenderSystem::Update(float dt)
{
	...
	for (auto const& entity : mEntities)
	{
		...
		if (signature.test(coordinator->GetComponentType<Collision>()))
		{
			...
			collision.boundingBox.SetOffsets(staticMesh.getAABB());
			collision.boundingBox.updatePosition(transform.position);
			collision.boundingBox.updateTransformedBounds();
